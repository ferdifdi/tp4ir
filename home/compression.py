...
class VBEPostings:
    ...
    def encode(postings_list):
        ...
        gap_based_list = postings_list.copy()
        for i in range(len(gap_based_list)-1,0,-1):
            gap_based_list[i] = gap_based_list[i] - gap_based_list[i-1]
    ...
    def vb_decode(encoded_bytestream):
        ...
        decoded_bytestream_list = decoded_bytestream.tolist()
        for ele in decoded_bytestream_list:
            if ele < 128:
                n = 128 * n + ele
            else:
                n = 128 * n + (ele - 128)
    ...
    def decode(encoded_postings_list):
        ...
        postings_list = gap_based_list.copy()
        for i in range(1,len(postings_list),1):
           postings_list[i] = postings_list[i] + postings_list[i-1] 
